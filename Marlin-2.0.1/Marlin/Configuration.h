...
#define CUSTOM_MACHINE_NAME "Ansys"
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 170/2    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 235.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 223          // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 103.5              // (mm) Get this value from G33 auto calibrate
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 25.98, 15, 0 }
